...
public class JFrameGestionClientes extends JFrame
{
	...
	public GCPanelBotonesClientes getPanelBotones() {
		return panelBotones;
	}

	public void setPanelBotones(GCPanelBotonesClientes panelBotones) {
		this.panelBotones = panelBotones;
	}

	public GCPanelListaClientes getPanelLista() {
		return panelLista;
	}

	public void setPanelLista(GCPanelListaClientes panelLista) {
